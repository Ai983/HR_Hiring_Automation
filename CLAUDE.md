...
- **`localStorage` keys are version-suffixed** (`hag_assessment_session_v3`) so a
...
### Current paper — `HAG-WALKIN-L1-v3`

25 questions · 25 marks · 35 minutes · no negative marking. Every question is a
situation: what would you **do**, what procedure would you follow, how would you
handle the client.
...
Bands: **21–25 STRONG · 15–20 AVERAGE · 10–14 WEAK · 0–9 BELOW_BAR.**

History: v1 = the printed 13-question paper (still the Wi-Fi-failure fallback).
v2 = the first online paper, 20 questions, superseded — it tested arithmetic and
site vocabulary, which separates people who have read a glossary from people who
have not, rather than people who can run a site from people who cannot. Do not
reuse either id.
